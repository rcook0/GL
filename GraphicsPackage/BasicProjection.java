 ...
 * @author Ryan L Cook.
 */
public class BasicProjection extends Matrix {

  /**Projection types
  public static final int PERSPECTIVE = 0;
  public static final int PERSPECTIVE2 = 1;
  ...
  /** The base matrix used in this constructor is zero-filled 4-by-4 matrix
  containing the value 1 all along the diagonal. */
    super(4, 4, 0);
...
*/
  ...
  public void general(
    ...
    Vector4d d // normalized direction vector
    )
  {
    m[0][2] = -(d.x()/d.z());
    m[0][3] = p.z() * (d.x()/d.z());
