...
public class View3dParameters extends Object {
  ...
  /* For debugging, return a list of the contents of this object. */
  public String catalogue() {
    return ("vrp = " + vrp + "vup = " + vup + "vpn = " + vpn
      + "prp = " + prp + "VRCumin  = " + VRCumin + "VRCumax = " + VRCumax
      + "VRCvmin = " + VRCvmin + "VRCvmax = " + VRCvmax);
  }
